...
export default function EmployeeDashboard() {
  return (
    <div className="min-h-screen bg-[radial-gradient(circle_at_top,_#fffdfb,_#f7f8fb_55%,_#e8eef6)] px-4 py-10 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-7xl">
        ...
        <div className="grid gap-4 pb-8 md:grid-cols-3">
          <div className="rounded-3xl border border-[#ffd2ad] bg-[linear-gradient(180deg,_#ffffff_0%,_#fff8f2_100%)] p-5 shadow-sm">
